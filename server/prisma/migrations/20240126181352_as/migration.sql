...
INSERT INTO "new_Employee" ("address", "allowances", "baseSalary", "basicSalary", "birthDate", "bonuses", "childrenCount", "createdAt", "deductions", "department", "email", "firstName", "gender", "hireDate", "id", "insurance", "jobLevel", "jobTitle", "lastName", "maritalStatus", "phone", "position", "socialStatus", "updatedAt") SELECT "address", "allowances", "baseSalary", "basicSalary", "birthDate", "bonuses", "childrenCount", "createdAt", "deductions", "department", "email", "firstName", "gender", "hireDate", "id", "insurance", "jobLevel", "jobTitle", "lastName", "maritalStatus", "phone", "position", "socialStatus", "updatedAt" FROM "Employee";
DROP TABLE "Employee";
